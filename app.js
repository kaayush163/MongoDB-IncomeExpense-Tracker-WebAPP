...
const accessLogStream = fs.createWriteStream(
  ...
  { flags: "a" } ///flag a will append new data to access log if not write flag a it will overwrtite the data previous one
);
...
mongoose
  .connect(`${process.env.MONGODB_ATLAS_URL}/expense-tracker`)
  .then((result) => {
